...
class InvalidCountryException extends Exception{
	...
	public String toString() {
		return "InvalidCountryException occurred\nUser Outside India cannot be registered";
	}
}
public class UserRegistration{
	public static void registerUser(String usernane,String userCountry) throws InvalidCountryException{
		if(!userCountry.equals("India")) throw new InvalidCountryException();
		else
